...
QWidget* CameraViewer::createNavigationWidget() {    
    try {
        ...
        listFiles->setMaximumHeight(0.9*Sheight);
        ...
        batteryLabel1->setFixedSize(Swidth/30, Sheight*0.1);
        batteryLabel1->setPixmap(scaledPixmapBattery);
        layout->addWidget(batteryLabel1); 
...
QWidget* CameraViewer::createVideoTab() {
    try {
        ...
        batteryLabel1->setFixedSize(Swidth/30, Sheight*0.1);
        batteryLabel1->setPixmap(scaledPixmapBattery);
        bottomLeftLayout->addWidget(batteryLabel1); 

        listvideos->setMaximumWidth(Swidth*0.9);
...
void CameraViewer::showFilesList(const std::string &folder_path, const std::string &suffix) {
    try {        
        pdf.addText(lang.getText("pdf_message","mode") + suffix + " - " + getCurrentDateTime());
        listFiles->clear();
        taskListWidget->clear();
